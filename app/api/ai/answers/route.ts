      ...
      const { text } = await generateText({
         ...
         prompt: `Generate a markdown-formatted response to the following question: "${question}".
           ...
           **User's Answer:** ${userAnswer}
           ...
           IMPORTANT: Your response MUST be only the raw markdown content. 
           DO NOT include any introductory, concluding, or conversational text (e.g., "Here's your answer:"). 
           Your response must start directly with the markdown content (e.g., a '##' heading or the first paragraph).`,
         system:
