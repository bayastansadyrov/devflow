...
export default function LeftSidebar() {
   return (
      <aside className="custom-scrollbar background-light900_dark200 light-border overlow-y-auto shadow-light-300 sticky top-0 left-0 flex h-screen flex-col justify-between border-r p-6 pt-36 max-sm:hidden lg:w-[266px] dark:shadow-none">
